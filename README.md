...
![NaviAge AI Banner](screenshots/hero.png) <!-- Note: Replace with actual screenshot for Devpost -->

## 🏆 Hackathon Overview
**NaviAge AI** is a comprehensive, accessibility-first web application designed to help senior citizens navigate technology with confidence. Built for GenLink Hacks, this project directly addresses the digital divide by offering an AI-powered assistant, interactive tutorials, and a safe scam-detection training environment.
...
2. Open the `dev_post_hackathon` folder.
3. Simply double-click `index.html` to open it in your browser!
4. *(Optional)* For the AI Assistant to work, ensure you have an active internet connection.

## 🌐 Deployment (Vercel/Netlify)

Since this project consists of pure HTML/CSS/JS, it can be deployed in simply 3 steps:
1. Log into your Vercel or Netlify dashboard.
2. Drag and drop the `dev_post_hackathon` folder onto the "Deploy" window.
3. In seconds, you will receive a free public link you can submit to DevPost!

---
*Built with ❤️ for our elders at GenLink Hacks.*
